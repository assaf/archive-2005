...
# Implements a microcontent parser by extending a class that includes this module.
#
# === The Basics
#
# To create a microcontent parser, extend a class with this module and use the
...
module MicrocontentParser
    ...
    #
    # If the extractor is a class, it references a microcontent parser which is
...
private
    ...
    def MicrocontentParser.included(mod)
        mod.extend(self)
    end
    ...
    #
    # For more information see MicrocontentParser.rule.
    class Rule
    ...
    #
    # For more information see MicrocontentParser.selector.
    class Selector
    ...
    #
    # For more information see MicrocontentParser.extractor.
    class Extractor
